...
#define STRING_CONFIG_H_AUTHOR "Villanova Wiredcats FRC 5885" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Wiredcats Ender-3 Pro"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -5, -2.5 }
